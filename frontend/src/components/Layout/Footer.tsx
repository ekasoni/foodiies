      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-orange-400 mb-4">🍽️ Foodies</h3>
            <p className="text-gray-300 mb-4">
              Discover amazing restaurants and delicious food delivered right to your doorstep. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/delivery" className="text-gray-300 hover:text-orange-400 transition-colors">
                  Delivery Info
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Foodies. All rights reserved. Made with ❤️ for food lovers.
          </p>
        </div>
      </div>
    </footer>
