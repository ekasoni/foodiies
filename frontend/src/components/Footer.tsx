...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    partners: [
      ...
      { name: 'For Corporate', href: '/corporate' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-primary-400">🍽️ Foodies</span>
            </div>
            <p className="text-gray-300 text-sm mb-4">
              Your favorite food, delivered fast. Discover amazing restaurants and order delicious meals with just a few clicks.
            </p>
